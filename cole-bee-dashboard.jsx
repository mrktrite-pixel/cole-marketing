...
const lifecycles = {
  "create-new-site": {
    ...
    steps: [
      ...
      { phase: "STAGE 5 — Validation Gate", bees: ["system checks: Can publish? Can track? Can sell? Can index? Can roll back? Can approve?"], status: "SPEC_ONLY", note: "🔴 Critical: hive does NOT start until all green. Status flips: setup_incomplete → active. ChatGPT-locked principle: no premature launch." },
